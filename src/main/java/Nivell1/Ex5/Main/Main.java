...
import Nivell1.Ex5.Modules.ArchivosTxt;

import java.util.ArrayList;
import java.util.Collections;
import java.util.Scanner;

import static Nivell1.Ex5.Modules.ArchivosTxt.*;
import static Nivell1.Ex5.Modules.GestionDeArchivos.totalDirectorios;
import static Nivell1.Ex5.Modules.GestionDeArchivos.volcadoDeDirectorio;
        ...
        if (!archivosTxt.isEmpty()) {
            do {
                ...
                if(opcion == -1) {
                    ...
                    serializarObjeto(archivosTxt.get(opcion));
